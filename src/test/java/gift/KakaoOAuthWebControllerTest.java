    ...
    void 카카오_OAuth_로그인_리다이렉트() throws Exception {
        mockMvc.perform(get("/oauth/kakao/login"))
                ...
                .andExpect(redirectedUrl(
                    "https://kauth.kakao.com/oauth/authorize?scope=account_email,profile_nickname,talk_message&response_type=code&client_id=test-api-key&redirect_uri=http://localhost:8080/oauth/kakao/callback"
                ));
    }
} 